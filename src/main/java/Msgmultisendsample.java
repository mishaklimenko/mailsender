...
code> where <i>to</i> and <i>from</i> are the destination and origin
 * email addresses, respectively, and <i>smtp</i> is the hostname of the machine
 * that has smtp server running. The last parameter either turns on or turns off
...
public class Msgmultisendsample {
	...
	public static void main(String[] args) {
		if (args.length != 4) {
			System.out
					.println("usage: java msgmultisend <to> <from> <smtp> true|false");
			return;
		}
		String to = args[0];
		String from = args[1];
